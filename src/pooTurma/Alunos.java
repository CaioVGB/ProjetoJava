...
public class Alunos {
	...
	public static void main(String[] args) {
		...
		System.out.println("Nome do aluno:" + aluno1.telefone);
		System.out.println("Nome do aluno:" + aluno1.email);
		aluno1.ligarPc();
		aluno1.logar();
		...
		aluno2.telefone ="11986020091";
		aluno2.email = "victoriacardoso545@gmail.com";
		System.out.println("Nome do aluno:" + aluno2.nome);
		System.out.println("Nome do aluno:" + aluno2.telefone);
		System.out.println("Nome do aluno:" + aluno2.email);
		aluno2.ligarPc();
        aluno2.desligarPc();
